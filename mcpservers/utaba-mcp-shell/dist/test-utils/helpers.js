...
// Test file utilities
export async function createTempTestFile(content) {
...
export function withEnvironmentVariable(name, value, fn) {
...
export function assertValidCommandResult(result) {
...
export function assertSecurityError(error, expectedReason) {
...
export function createMockMCPRequest(toolName, args) {
    return {
        params: {
            name: toolName,
            arguments: args
...
export function parseMCPResponseJSON(response) {
