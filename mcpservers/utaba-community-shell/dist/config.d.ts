...
export declare const ConfigSchema: z.ZodEffects<z.ZodObject<{
    ...
    defaultProjectRoot: z.ZodOptional<z.ZodString>;
    approvalQueueBaseDir: z.ZodOptional<z.ZodString>;
    asyncQueueBaseDir: z.ZodOptional<z.ZodString>;
    ...
    approvalQueueBaseDir?: string | undefined;
    asyncQueueBaseDir?: string | undefined;
...
export declare const DEFAULT_CONFIGS: {
    ...
    readonly nodejs: {
        ...
        readonly allowedCommands: readonly [{
            readonly command: "npm";
            readonly allowedArgs: readonly ["test", "run", "install", "ci", "audit", "outdated", "list", "build"];
            readonly description: "Node Package Manager";
            readonly timeout: 60000;
            readonly workingDirRestriction: "project-only";
        }, {
            ...
            readonly allowedArgs: readonly ["status", "diff", "log", "branch", "add", "commit", "push", "pull", "-F"];
...
export declare function startDirectory(): Promise<string>;
/**
