...
export declare class SecurityValidator {
     ...
     */
    validateCommand(command: string, args: string[] | undefined, workingDirectory: string, startDirectory: string): ValidationResult;
    resolveWorkingDirectory(startDirectory: string, workingDirectory: string): string;
    /**
